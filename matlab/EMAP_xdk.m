...
%
% EXAMPLE 1
% EMAP('PaviaPCA','PaviaEMAP', false, 'a', [10 15], 'd', [50 100 500]); 
% 
% EXAMPLE 2
% EMAP('PaviaPCA','PaviaEMAP', false, 'a', [10 15], 's', 'Pavia_training.tif');  
% 
% EXAMPLE 3
% EMAP('PaviaPCA','PaviaEMAP', false, 'a', [10 15 20], 'd', [50 100 500], 's', 150);
%
% Mattia Pedergnana
% mattia@mett.it
% 15/08/2011
...
function [EMAPOutput, TimeProfile, Bands, FeatOtput] = EMAP_xdk(varargin)
% InputImage,...
% OutputImage,...
% PCA,...
% VectorAttributes,...
